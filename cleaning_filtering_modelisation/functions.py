...
def pos_cash(num_rows=None, nan_as_category=True):
    pos = pd.read_csv('./home-credit-default-risk/POS_CASH_balance.csv', nrows=num_rows)
...
def credit_card_balance(num_rows=None, nan_as_category=True):
    cc = pd.read_csv('./home-credit-default-risk/credit_card_balance.csv', nrows=num_rows)
...
def display_importances(feature_importance_df, savefig=False):
